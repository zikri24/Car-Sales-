<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.Master" AutoEventWireup="true" CodeBehind="SearchResult2.aspx.cs" Inherits="CarSales.SearchResult1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div id="Grid">
        <asp:GridView ID="GridViewResult" runat="server" AutoGenerateColumns="False" 
            ...
            Width="65%" AllowPaging="True" PageSize="2" DataKeyNames="CarID" 
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <div id= "container">
                    <div id = "image">
                       <asp:Image ID="Image3" runat="server" ImageUrl='<%# Eval("LinkToFile") %>'/><br />
                        ...
                        <div id = "info">
                            ...
                            <asp:LinkButton ID="LinkbtnView" runat="server" ForeColor="#003399" 
